  ...
  return (
    <div className="App">
      <div className="contenedor">
        <aside className="leftnav">LEFT NAV</aside>
        <section className="content">
          <header className="header">HEADER</header>
          <Lorem small={smallcontent} />
        </section>
        <footer className="player">PLAYER
        <button onClick={() => setsmallcontent(!smallcontent)}>
          {smallcontent ? 'To large content' : 'To small content'}
        </button>
        </footer>
      </div>
    </div>
